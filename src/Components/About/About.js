            ...
            <div className="row">
              <div className="columns contact-details">
                ...
                <p className="address">
                  ...
                  <h4 style={{ color: "white" }} > Emails</h4>
                  <span>ChrisJobs046@gmail.com</span>
                </p>
              </div>
              <div className="columns download">
                <p>
                  <a href="/src/CV/CV3.5_Software Christopher Alexander.pdf" rel="noopener noreferrer" without="true" className="button" download=""><i className="fa fa-download" />Download CV</a>
                </p>
              </div>
            </div>
          </div>
